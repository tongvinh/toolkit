...
var slugTests = []struct {
	...
	{name: "japanese string", s: "こんにちは言葉", expected: "", errorExpected: true},
	{name: "japanese string and roman characters", s: "hello world こんにちは言葉", expected: "hello-world", errorExpected: false},
}
...
func TestTools_DownloadStaticFile(t *testing.T) {
	...
	if res.Header["Content-Length"][0] != "3465318" {
...
func TestTools_ErrorJSON(t *testing.T) {
	...
	if rr.Code != http.StatusServiceUnavailable {
		t.Errorf("wrong status code retured; expected 503, but got %d", rr.Code)
	}
}
