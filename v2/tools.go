...
// to all the methods with the reciever *Tool
type Tools struct {
	MaxFileSize        int
...
// PushJSONToRemote posts arbitrary data to some URl as JSON, and returns the response, status code, and errors, if any
